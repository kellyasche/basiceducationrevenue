...
eqrev3.1pct <- original %>%
  ...
  mutate(eqrev3.1pct = 0.0,
         eqrev3.1pct = ifelse(eqgroup.label == "metroeq", (eqrev1.1pct + eqrev2.1pct) * 0.25, eqrev3),
         eqrev3.1pct = ifelse(eqgroup.label == "ruraleq", (eqrev1.1pct + eqrev2.1pct) * 0.25, eqrev3)) %>%
...
# A 1% increase{.tabsets}
The following will provide the change in revenue if all components were increased by 1%. 
...
Let's see what this looks like between types of schools (charter vs. public).
